...
def generate_message(username):
    return (f"🧠 Привет! Я делаю диплом по визуальному восприятию и собираю анонимные ответы. Нужно просто закрасить картинку. Это не тест и не оценка, просто исследование) Можешь помочь? Вот ссылка 👉 https://suicide-detector.onrender.com/?user={username.lstrip('@')}")
